...
public class logisticsAction extends LookupDispatchAction {
    ...
    public ActionForward generate(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws java.lang.Exception {
        displayForm formulaire = (displayForm) request.getSession().getAttribute("display");
        try {
            new display (formulaire);
